...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/gilwong00/task-runner/internal/gen/proto/worker/v1"
	http "net/http"
	strings "strings"
)
...
func NewWorkerServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WorkerServiceClient {
	...
	workerServiceMethods := v1.File_proto_worker_v1_worker_proto.Services().ByName("WorkerService").Methods()
